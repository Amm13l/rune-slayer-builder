import { Weapon, Helmet, Chest, Boots, Shield, Sash, Ring, Lantern, Back, Fairy } from './types.js';
import racesDatabase from './races.js';
...
const itemsDatabaseHelmet = {
  ...
  EverwinterCrown: new Helmet({
    ...
    stats: {strength: 5, agility: 15, stamina: 2,
      critDamage: 0.03, speedBoost: 0.02, coldResistance: 0.1,
    tundraVisibility: 0.1},
    armor: 360,
    type: 'medium',
    level: 50,
...
const itemsDatabaseBoots = {  
  ...
  ZircBoots: new Boots({
    name: 'Zirc Boots',
    stats: {strength: 12, stamina: 5, physicalPierce: 0.01},
    armor: 400,
    type: 'heavy',
    level: 42,
    rarity: 'uncommon'
  ...
  BrimfrostBoots: new Boots({
    ...
    stats: {strength: 30, spirit: 4, critDamage: 0.02, coldResistance: 0.15},
    armor: 450,
    type: 'heavy',
    level: 45,
    rarity: 'epic'
...
const itemsDatabaseWeapons = {
  ...
  SpectreDagger: new Weapon({
    name: 'Spectre Dagger',
    damage: {physical: 11},
    stats: {spirit: 6, agility: 10},
    type: 'dagger',
    level: 31,
    rarity: 'rare',
    description: '(Specs - unobtainable) Chance on hit to fire a spectre bolt at your enemy.'
  }),
  ...
  ForgottenHerosSword: new Weapon({
  ...
  RunicCutlass: new Weapon({
    name: 'Runic Cutlass',
    damage: {physical: 17},
    stats: {strength: 27, agility: 10, critChance: 0.02, physicalPierce: 0.04},
    type: 'sword',
    level: 50,
    rarity: 'legendary',
  }),
  StSavensRetribution: new Weapon({
    name: 'St. Saven\'s Retribution',
    damage: {physical: 25},
    stats: {strength: 11, stamina: 4},
    type: 'sword',
    level: 40,
  ...
  GiftOfSuveriasSacredLight: new Weapon({
    name: 'Gift of Suveria\'s Sacred Light',
    damage: {holy: 15},
    stats: {intellect: 15, spirit: 30, magicCritChance: 0.02},
    type: 'sword',
    level: 50,
    rarity: 'legendary',
  ...
  ThunderbiteSpear: new Weapon({
    name: 'Thunderbite Spear',
    damage: {physical: 24, lightning: 6},
    stats: {strength: 40, spirit: 10, stamina: 15, critChance: 0.04, physicalPierce: 0.10},
    type: 'spear',
    level: 40,
    rarity: 'legendary',
    description: '(Specs - unobtainable) Critical hits with Thunderbite unleashes the storm within the spear.'
  }),
  HarpoonSpear: new Weapon({
    name: 'Harpoon Spear',
    damage: {physical: 11, fire: 4},
    stats: {strength: 16, critChance: 0.02, physicalPierce: 0.05},
    type: 'spear',
  ...
  BladeOfASinner: new Weapon({
    name: 'Blade of A Sinner',
    damage: {physical: 11},
    stats: {strength: 20, stamina: 4, critChance: 0.015, physicalPierce: 0.04},
    type: 'greatsword',
    level: 40,
    rarity: 'legendary',
    description: '(Specs - unobtainable) When the Blade bleeds, you apply hemorrhage on enemies.'
  }),
  Rimehowl: new Weapon({
    name: 'Rimehowl',
    damage: {physical: 20},
  ...
  BoarbladeKatana: new Weapon({
    name: 'Boarblade Katana',
    damage: {physical: 9},
  ...
  IceGolemStaff: new Weapon({
    name: 'Ice Golem Staff',
    damage: {physical: 11},
    stats: {intellect: 28, spirit: 10, stamina: 4, magicCritChance: 0.04},
    type: 'staff',
    level: 45,
    rarity: 'epic'
  }),
...
const itemsDatabaseRings = {
  ...
  MinersRing: new Ring({
    name: 'Miner\'s Ring',
    description: '(Specs - unobtainable) Enhances mining efficiency.',
    rarity: 'uncommon'
  }),

  LumberjackRing: new Ring({
    name: 'Lumberjack Ring',
    description: '(Specs - unobtainable) Enhances tree chopping efficiency.',
    rarity: 'uncommon'
  }),
...
const itemDatabaseFairies = {
  ...
  DarkFairy: new Fairy({
    ...
    stats: {luck: 8},
    rarity: 'legendary',
    description: '(Specs - unobtainable) Gives certain Holy Spells +25% more Damage.'
  }),
